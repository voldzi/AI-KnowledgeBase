...
title: "Vzor: uživatelský postup aplikace"
external_ref: DOC-AKB-TEMPLATE-USER
application_id: akb
owner: akb-team
...
# Vzor: uživatelský postup aplikace
...
| Pole k vyplnění | Hodnota autora |
| --- | --- |
| Název úlohy a aplikace | DOPLNIT |
| Pro koho je postup určen | DOPLNIT |
| Verze aplikace a prostředí | DOPLNIT |
| Revize návodu, vlastník, datum ověření | DOPLNIT |

## Účel

DOPLNIT: Co uživatel dokončí. Jedna krátká věta, nikoli obecný popis produktu.
...
1. DOPLNIT: Kde začít a jak poznat správnou obrazovku.
2. DOPLNIT: Jaká pole nebo volby změnit; uvést jednotky, je-li to relevantní.
3. DOPLNIT: Jak potvrdit operaci a co se tím skutečně provede.

Obrázek použijte jen jako doplněk s popisem, bez osobních údajů. Důležité informace musí být i v textu.

## Ověření výsledku

DOPLNIT: Konkrétní stav nebo údaj, který potvrzuje úspěch; kdo jej uvidí a zda následuje schvalování.

## Když se úkon nepodaří

| Projev | Bezpečný další krok |
| --- | --- |
| DOPLNIT | DOPLNIT |
