...
| `services/ingestion-service` | Ingestion jobs, source parsing, feature-gated Docling/GraniteDocling extraction, OCR fallback, logical chunking, embeddings, Qdrant/OpenSearch indexing, ingestion reports. |
