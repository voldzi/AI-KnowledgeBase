...
| DW-07 | Viewer | Open source preview or citation context. | Audit-backed source-context chunk opens from document detail, source/version/page/section/text are visible, and the user can distinguish this from full native viewer/download capability. |
