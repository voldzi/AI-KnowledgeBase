...
3. Zvolte společný konzistentní bod obnovy. Obnovte PostgreSQL, odpovídající objekty a stav identity včetně databáze Keycloaku a odděleně chráněných klíčů. Ověřte vazby přesných verzí dokumentů na objekty dříve, než povolíte zápis nebo přístup uživatelů.
...
- [Provoz a správa](akb-stratos-provoz-pilot-csu-cs.md)
