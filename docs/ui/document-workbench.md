...
- krok `Pravidla` zobrazuje ctenari overene citovane limity; navrhy jsou pracovni pohled gestora/schvalovatele, nikoli bezna ctenarska data; precedence konflikt a pouzitelnost dalsimi aplikacemi zustavaji rozlisene,
...
- kazde vytezene pravidlo ukazuje lidsky typ zdroje, stav overeni a odkaz `Otevrit citovane misto`, ktery pripina presnou verzi, chunk a dostupnou stranu; pri nedostupnem chunku se nevydava obsah jine verze za citaci a uzivatel muze overit zdroj v nahledu pripnute verze,
...
- citace z Employee Chat Portal pouzivaji sdileny STRATOS Dialog nad aplikacni hlavickou, s uzavrenim, navratem focusu, zachycenim klavesnice a rezimy okno/panel/cela obrazovka; pri zmene vlakna nebo verze se stare nacitani zrusi a pozdni odpoved nezameni citaci; akce `Otevrit dokument` otevre v novem tabu primo zdrojovy soubor pres assistant citation redirect,
