...
- Citace z Knowledge Chat i Employee Assistant jsou sjednocene pres sdileny citation viewer. Otevreni citace zobrazi formatovany source-context a odkaz `Otevrit dokument` otevre v novem tabu detail dokumentu ve viewer tabu s predvybranym chunkem, bez ztraty historie dotazu. Primy assistant citation redirect na podepsany zdroj zustava API kompatibilni.
