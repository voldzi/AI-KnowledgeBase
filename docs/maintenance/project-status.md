...
1. Native viewer/download: detail dokumentu umi otevrit citovatelny RAG source-context chunk, ale PDF/DOCX/tabulky/OCR zatim nemaji produkcni viewer s page jump, highlight a signed download URL.
...
1. Native viewer/download: signed source open, PDF page jump/highlight, DOCX/text preview a nativni zobrazeni tabulek/OCR.
