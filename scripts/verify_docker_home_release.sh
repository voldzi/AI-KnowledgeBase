...
export REGISTRY_API_IMAGE="akb/registry-api:${TARGET_SHA}"
export INGESTION_SERVICE_IMAGE="akb/ingestion-service:${TARGET_SHA}"
export RAG_RETRIEVAL_SERVICE_IMAGE="akb/rag-retrieval-service:${TARGET_SHA}"
export EVALUATION_SERVICE_IMAGE="akb/evaluation-service:${TARGET_SHA}"
export GOVERNANCE_SERVICE_IMAGE="akb/governance-service:${TARGET_SHA}"
export WEB_IMAGE="akb/web:${TARGET_SHA}"
export CHAT_WEB_IMAGE="akb/chat-web:${TARGET_SHA}"
export LLM_GATEWAY_SERVICE_IMAGE="akb/llm-gateway-service:${TARGET_SHA}"
COMPOSE=(
  docker compose
...
for service in "${services[@]}"; do
  ...
  case "$service" in
    ...
    evaluation-service)
      ...
      ;;
    governance-service)
      health_url="${local_base}/governance/health"
      ready_url="${local_base}/governance/ready"
      ;;
    web)
