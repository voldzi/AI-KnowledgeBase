...
def main() -> int:
    retire_legacy_mutation("scripts/phase_03_docs_import_smoke.py")
...
def import_docs_subset() -> dict[str, Any]:
    retire_legacy_mutation("scripts/phase_03_docs_import_smoke.py import_docs_subset")
    ...
    *,
    ...
    if normalized_method != "GET":
        retire_legacy_mutation(
            f"scripts/phase_03_docs_import_smoke.py request_json {normalized_method}"
        )
