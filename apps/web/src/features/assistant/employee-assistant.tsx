...
const assistantCopy = {
  cs: {
    defaultQuestion: "Jaké povinnosti platí pro informační systémy veřejné správy?",
  ...
  en: {
    defaultQuestion: "What obligations apply to public administration information systems?",
