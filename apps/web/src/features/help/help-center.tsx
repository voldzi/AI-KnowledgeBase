...
const helpCopy = {
  cs: {
    ...
    viewerBody: "Citace z chatu otevírá source-context. Detail dokumentu umí připravit podepsané otevření zdrojového souboru; cílově má viewer otevřít přesnou stranu, oddíl, řádek, slide nebo OCR bbox podle typu dokumentu.",
  ...
  en: {
    ...
    viewerBody: "A chat citation opens source-context. Document detail can prepare signed source opening; the target viewer should open exact page, section, row, slide or OCR bbox by document type.",
