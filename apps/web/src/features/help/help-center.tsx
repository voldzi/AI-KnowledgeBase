...
const helpCopy = {
  cs: {
    ...
    viewerBody: "Citace z chatu otevírá source-context. Detail dokumentu umí připravit podepsané otevření zdroje a zobrazit PDF stránku citace přes pdf.js s textovým/bbox zvýrazněním, Markdown jako formátovaný dokument s obsahem a citací, obrázky/OCR s bbox, DOCX, XLSX, prezentace, text a CSV.",
  ...
  en: {
    ...
    viewerBody: "A chat citation opens source-context. Document detail can prepare signed source opening and render the cited PDF page through pdf.js with text/bbox highlighting, Markdown as a formatted document with contents and citation highlighting, image/OCR with bbox, DOCX, XLSX, presentations, text and CSV.",
