...
NO_ANSWER_TEXT = "K dotazu nebyl nalezen dostatečně důvěryhodný zdroj v povolených dokumentech."
        ...
        *,
        ...
        if missing_citation:
            return PolicyDecision(
                ...
                missing_information="Nalezený chunk nemá dostatečná citační metadata.",
            )
        ...
        if top_score < self._settings.no_answer_min_score:
            ...
            return PolicyDecision(
                ...
                confidence="insufficient_source",
                warnings=warnings,
                missing_information="Nejlepší nalezený zdroj nemá dostatečnou relevanci.",
            )
...
def _missing_information(value: str | None, response_language: ResponseLanguage) -> str | None:
    if response_language == "cs" or value is None:
        return value
    translations = {
        "Chybí citovatelný chunk v povolených dokumentech.": "A citable source is missing from the allowed documents.",
        "Nalezený chunk nemá dostatečná citační metadata.": "The retrieved source does not have sufficient citation metadata.",
        "Nejlepší nalezený zdroj nemá dostatečnou relevanci.": "The best retrieved source is not relevant enough.",
    }
